...
///////////////////////////////////////////////////////////////////////
 ...
 router.get("/category/:id",function(req,res){
    ...
    Category.findById(req.params.id).populate("companyname").exec(function(err,foundCategory){
...
router.get("/company/:id",function(req,res){
    ...
    Company.findById(req.params.id).populate("products").exec(function(err,foundCompany){
